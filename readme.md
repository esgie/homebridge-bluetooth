...
Reading the Apple HAP protocol, most characteristic values are uint8 values. In my case, i read humidity, that is "float". With new Date(), i take hours and minutes, bring that to a "hour.minutes" format and send that to the ESP once a day.  
