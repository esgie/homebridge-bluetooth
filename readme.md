...
The chip itself is programmed to wakeup (as an example 2 hours). Then the chip wake up, the sensor send his values and go back into deep sleep (in my case hibernation state).
